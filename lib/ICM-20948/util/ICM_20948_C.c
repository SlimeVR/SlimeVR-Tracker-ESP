...
ICM_20948_Status_e SetBiasGyroX(ICM_20948_Device_t* pdev,  int newValue)
{
    ...
    result = inv_icm20948_write_mems(pdev, GYRO_BIAS_X, 4, (const unsigned char*)&gyro_bias_reg);
    return result;
}
...
ICM_20948_Status_e SetBiasGyroY(ICM_20948_Device_t* pdev,  int newValue)
{
    ...
    gyro_bias_reg[2] = (unsigned char)(newValue >> 8);
    gyro_bias_reg[3] = (unsigned char)(newValue & 0xff);
    result = inv_icm20948_write_mems(pdev, GYRO_BIAS_Y, 4, (const unsigned char*)&gyro_bias_reg);
    return result;
}
...
ICM_20948_Status_e SetBiasGyroZ(ICM_20948_Device_t* pdev,  int newValue)
{
    ...
    gyro_bias_reg[2] = (unsigned char)(newValue >> 8);
    gyro_bias_reg[3] = (unsigned char)(newValue & 0xff);
    result = inv_icm20948_write_mems(pdev, GYRO_BIAS_Z, 4, (const unsigned char*)&gyro_bias_reg);
    return result;
}
...
ICM_20948_Status_e GetBiasGyroX(ICM_20948_Device_t* pdev, int *bias)
{
    ...
    result = inv_icm20948_read_mems(pdev, GYRO_BIAS_X, 4, &bias_data);
...
ICM_20948_Status_e GetBiasGyroY(ICM_20948_Device_t* pdev, int* bias)
{
    ICM_20948_Status_e result = ICM_20948_Stat_Ok;
    unsigned char bias_data[4] = { 0 };
    result = inv_icm20948_read_mems(pdev, GYRO_BIAS_Y, 4, &bias_data);
    bias[0] = (int)(bias_data[0] << 24) | (bias_data[1] << 16) | (bias_data[2] << 8) | (bias_data[3]);
    return result;
}
...
ICM_20948_Status_e GetBiasGyroZ(ICM_20948_Device_t* pdev, int* bias)
{
    ICM_20948_Status_e result = ICM_20948_Stat_Ok;
    unsigned char bias_data[4] = { 0 };
    result = inv_icm20948_read_mems(pdev, GYRO_BIAS_Z, 4, &bias_data);
    bias[0] = (int)(bias_data[0] << 24) | (bias_data[1] << 16) | (bias_data[2] << 8) | (bias_data[3]);
    return result;
}
//Accel Bias
ICM_20948_Status_e SetBiasAccelX(ICM_20948_Device_t* pdev,  int newValue)
{
    ...
    result = inv_icm20948_write_mems(pdev, ACCEL_BIAS_X, 4, (const unsigned char*)&accel_bias_reg);
    return result;
}
...
ICM_20948_Status_e SetBiasAccelY(ICM_20948_Device_t* pdev,  int newValue)
{
    ...
    accel_bias_reg[2] = (unsigned char)(newValue >> 8);
    accel_bias_reg[3] = (unsigned char)(newValue & 0xff);
    result = inv_icm20948_write_mems(pdev, ACCEL_BIAS_Y, 4, (const unsigned char*)&accel_bias_reg);
    return result;
}
...
ICM_20948_Status_e SetBiasAccelZ(ICM_20948_Device_t* pdev,  int newValue)
{
    ...
    accel_bias_reg[2] = (unsigned char)(newValue >> 8);
    accel_bias_reg[3] = (unsigned char)(newValue & 0xff);
    result = inv_icm20948_write_mems(pdev, ACCEL_BIAS_Z, 4, (const unsigned char*)&accel_bias_reg);
    return result;
}
...
ICM_20948_Status_e GetBiasAccelX(ICM_20948_Device_t* pdev, int* bias)
{
    ICM_20948_Status_e result = ICM_20948_Stat_Ok;
    unsigned char bias_data[4] = { 0 };
    result = inv_icm20948_read_mems(pdev, ACCEL_BIAS_X, 4, &bias_data);
    bias[0] = (int)(bias_data[0] << 24) | (bias_data[1] << 16) | (bias_data[2] << 8) | (bias_data[3]);
    return result;
}
...
ICM_20948_Status_e GetBiasAccelY(ICM_20948_Device_t* pdev, int* bias)
{
    ICM_20948_Status_e result = ICM_20948_Stat_Ok;
    unsigned char bias_data[4] = { 0 };
    result = inv_icm20948_read_mems(pdev, ACCEL_BIAS_Y, 4, &bias_data);
    bias[0] = (int)(bias_data[0] << 24) | (bias_data[1] << 16) | (bias_data[2] << 8) | (bias_data[3]);
    return result;
}
...
ICM_20948_Status_e GetBiasAccelZ(ICM_20948_Device_t* pdev, int* bias)
{
    ICM_20948_Status_e result = ICM_20948_Stat_Ok;
    unsigned char bias_data[4] = { 0 };
    result = inv_icm20948_read_mems(pdev, ACCEL_BIAS_Z, 4, &bias_data);
    bias[0] = (int)(bias_data[0] << 24) | (bias_data[1] << 16) | (bias_data[2] << 8) | (bias_data[3]);
    return result;
}
//CPass Bias
ICM_20948_Status_e SetBiasCPassX(ICM_20948_Device_t* pdev,  int newValue)
{
    ...
    result = inv_icm20948_write_mems(pdev, CPASS_BIAS_X, 4, (const unsigned char*)&cpass_bias_reg);
    return result;
}
...
ICM_20948_Status_e SetBiasCPassY(ICM_20948_Device_t* pdev,  int newValue)
{
    ...
    cpass_bias_reg[2] = (unsigned char)(newValue >> 8);
    cpass_bias_reg[3] = (unsigned char)(newValue & 0xff);
    result = inv_icm20948_write_mems(pdev, CPASS_BIAS_Y, 4, (const unsigned char*)&cpass_bias_reg);
    return result;
}
...
ICM_20948_Status_e SetBiasCPassZ(ICM_20948_Device_t* pdev,  int newValue)
{
    ...
    cpass_bias_reg[2] = (unsigned char)(newValue >> 8);
    cpass_bias_reg[3] = (unsigned char)(newValue & 0xff);
    result = inv_icm20948_write_mems(pdev, CPASS_BIAS_Z, 4, (const unsigned char*)&cpass_bias_reg);
    return result;
}
...
ICM_20948_Status_e GetBiasCPassX(ICM_20948_Device_t* pdev, int* bias)
{
    ICM_20948_Status_e result = ICM_20948_Stat_Ok;
    unsigned char bias_data[4] = { 0 };
    result = inv_icm20948_read_mems(pdev, CPASS_BIAS_X, 4, &bias_data);
    bias[0] = (int)(bias_data[0] << 24) | (bias_data[1] << 16) | (bias_data[2] << 8) | (bias_data[3]);
    return result;
}
...
ICM_20948_Status_e GetBiasCPassY(ICM_20948_Device_t* pdev, int* bias)
{
    ICM_20948_Status_e result = ICM_20948_Stat_Ok;
    unsigned char bias_data[4] = { 0 };
    result = inv_icm20948_read_mems(pdev, CPASS_BIAS_Y, 4, &bias_data);
    bias[0] = (int)(bias_data[0] << 24) | (bias_data[1] << 16) | (bias_data[2] << 8) | (bias_data[3]);
    return result;
}
...
ICM_20948_Status_e GetBiasCPassZ(ICM_20948_Device_t* pdev, int* bias)
{
    ICM_20948_Status_e result = ICM_20948_Stat_Ok;
    unsigned char bias_data[4] = { 0 };
    result = inv_icm20948_read_mems(pdev, CPASS_BIAS_Z, 4, &bias_data);
    bias[0] = (int)(bias_data[0] << 24) | (bias_data[1] << 16) | (bias_data[2] << 8) | (bias_data[3]);
    return result;
}
